...
// gas policies
export const ARB_ALCHEMY_POLICY_ID = process.env.ARB_ALCHEMY_POLICY_ID;
export const BASE_ALCHEMY_POLICY_ID = process.env.BASE_ALCHEMY_POLICY_ID;
export const MAINNET_ALCHEMY_POLICY_ID = process.env.MAINNET_ALCHEMY_POLICY_ID;
export const OPT_ALCHEMY_POLICY_ID = process.env.OPT_ALCHEMY_POLICY_ID;
